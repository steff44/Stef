...
function debut_page(string $titre, string $page_active = ''): void
{
    ...
    $onglets  = [
        ...
        'galerie-club' => ['Galerie (Galerie du Club)', 'galerie-club.php'],
...
<link rel="icon" type="image/vnd.microsoft.icon" href="../favicon.ico?v=202608311412">
...
<header class="site-header">
  <nav class="nav" aria-label="Navigation principale">
    <a class="logo" href="../index.html"><img class="logo-mark" src="../images/logo-icone.png" alt=""><span class="logo-text">Focal Club<br>Turballais</span></a>
    ...
    <ul class="nav-links" id="nav-links">
      ...
      <li><a href="../fiches-pratiques.html" target="_blank" rel="noopener noreferrer">Fiches Pratiques</a></li>
